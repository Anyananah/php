            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="opCardapio.php?phpacao=cadastrar" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                while ($linha = $lista->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <div class="modal fade" id="modalExcluir<?php echo $linha['idcardapio']?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
